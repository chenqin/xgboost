...
$submit --cluster=local --num-workers=4 --local-num-attempt=11 ~/xgboost/xgboost machine.conf 10000 mock=0,10,1,0 mock=1,10,1,0 mock=1,10,1,1 mock=0,10,1,0 mock=4,10,1,0 mock=9,10,1,0 mock=8,10,2,0 mock=4,10,3,0
